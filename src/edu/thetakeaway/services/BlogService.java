...
public class BlogService {
    ...
    public void ajouter(Blog t) {
		try {
            ...
            pst.setInt(1, SharedData.currentUser.getId());
	...
	public List<Blog> list() {
        ...
        try {
            ...
            while (rs.next()) {
                blogs.add(new Blog(rs.getInt("id"),rs.getString("author_id"),rs.getString("title"),rs.getString("contenu"),rs.getDate("date"),rs.getString("statut")));
            }
