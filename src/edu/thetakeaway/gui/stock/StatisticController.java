...
public class StatisticController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        set1.getData().add(new XYChart.Data("Carla Dawson", S.Statistiquee().get(0)));
        set1.getData().add(new XYChart.Data("Steel Moon", S.Statistiquee().get(1)));
        set1.getData().add(new XYChart.Data("amir yasi", S.Statistiquee().get(2)));
